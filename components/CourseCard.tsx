...
export function CourseCard({ course, progress, href }: CourseCardProps) {
  return (
    ...
    >
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-800 flex flex-col">
        {/* Course Image */}
        ...
        <div className="p-5 flex flex-col flex-1 space-y-3">
          ...
          {/* Progress Bar */}
          {typeof progress === "number" && (
            <CourseProgress progress={progress} variant="default" size="sm" label="Progress" />
          )}
        </div>
      </div>
    </Link>
